...
function UserRecommendedPosts() {
    ...
    const handleSubmit = async () => {
        ...
        const response = await callAPI('/accounts/'+username+'/recommended-posts','GET');
        console.log('response',response)
        if(response.count){
            setOutput(response.recommended_posts);
        }else{
...
export default UserRecommendedPosts
